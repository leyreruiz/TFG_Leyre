...
class ExplainerAgent(BaseAgent):
    ...
    def handle(
        ...
        system = (
            ...
            "IMPORTANT: You may ONLY answer questions that are related to the subject being studied."
            f"{topic_hint}{section_hint} "
            "If the question is unrelated to the topic or active section, nonsensical, or has no academic relevance, "
            "respond ONLY with a short sentence explaining that you can only answer questions about the course material, "
            "and end your response with exactly: [REFUSED] "
            "Do not answer questions about completely unrelated topics, jokes, absurd questions, or irrelevant content. "
